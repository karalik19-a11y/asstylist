  ...
  return (
    <div className={`boot-intro boot-intro--${phase}`} aria-hidden="true">
      <div className="boot-intro-logo">
        <div className="boot-intro-word">
          <img className="boot-intro-image" src={LOGO_SRC} alt="" />
        </div>
