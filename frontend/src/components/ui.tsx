  ...
  return (
    <span className={`devil-a ${className}`.trim()} aria-hidden="true">
      <svg className="devil-a-horns" viewBox="0 0 40 18" width="1em" height="0.45em" fill="none">
        <path
          d="M6 16 C4 8 2 2 8 1 C10 4 11 10 12 16"
          stroke="currentColor"
          strokeWidth="2.2"
          strokeLinecap="round"
        />
        <path
          d="M34 16 C36 8 38 2 32 1 C30 4 29 10 28 16"
          stroke="currentColor"
          strokeWidth="2.2"
          strokeLinecap="round"
        />
      ...
      <svg className="devil-a-tail" viewBox="0 0 28 22" width="0.7em" height="0.55em" fill="none">
        <path
          d="M2 2 C10 4 14 12 12 18 C16 14 22 12 26 16"
          stroke="currentColor"
          strokeWidth="2"
          strokeLinecap="round"
        />
